...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Ago-2018 às 16:09
...
--
-- Estrutura da tabela `log_mudanca_perfil`
--

DROP TABLE IF EXISTS `log_mudanca_perfil`;
CREATE TABLE `log_mudanca_perfil` (
  `id_log_mudanca_perfil` varchar(10) NOT NULL,
  `id_usuario` int(8) DEFAULT NULL,
  `mudanca_img_perfil` varchar(100) DEFAULT NULL,
  `mudanca_img_fundo` varchar(100) DEFAULT NULL,
  `data_hora` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `log_postagem` (
  ...
  `id_postagem` int(8) DEFAULT NULL,
  `data_hora` datetime DEFAULT NULL,
  `id_log_tipo_postagem` int(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estrutura da tabela `tipo_log_postagem`
--

DROP TABLE IF EXISTS `tipo_log_postagem`;
CREATE TABLE `tipo_log_postagem` (
  `id_tipo_log_postagem` int(4) NOT NULL,
  `id_log_tipo_postagem` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `log_mudanca_perfil`
--
ALTER TABLE `log_mudanca_perfil`
  ADD PRIMARY KEY (`id_log_mudanca_perfil`);
...
ALTER TABLE `log_postagem`
  ...
  ADD KEY `id_postagem` (`id_postagem`),
  ADD KEY `id_log_tipo_postagem` (`id_log_tipo_postagem`);
...
--
-- Indexes for table `tipo_log_postagem`
--
ALTER TABLE `tipo_log_postagem`
  ADD PRIMARY KEY (`id_tipo_log_postagem`);
...
--
ALTER TABLE `comentario`
  ADD CONSTRAINT `comentario_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `comentario` (`id_comentario`);

--
-- Limitadores para a tabela `frete`
--
ALTER TABLE `frete`
  ADD CONSTRAINT `frete_ibfk_1` FOREIGN KEY (`id_regiao_frete`) REFERENCES `frete` (`id_frete`);

--
-- Limitadores para a tabela `logo_log_in_cadastro_saida`
--
ALTER TABLE `logo_log_in_cadastro_saida`
  ADD CONSTRAINT `logo_log_in_cadastro_saida_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `logo_log_in_cadastro_saida` (`id_log_registo_usuario`);

--
-- Limitadores para a tabela `log_postagem`
--
ALTER TABLE `log_postagem`
  ADD CONSTRAINT `log_postagem_ibfk_1` FOREIGN KEY (`id_usuario_adm`) REFERENCES `log_postagem` (`id_log_postagem`),
  ADD CONSTRAINT `log_postagem_ibfk_2` FOREIGN KEY (`id_postagem`) REFERENCES `log_postagem` (`id_log_postagem`),
  ADD CONSTRAINT `log_postagem_ibfk_3` FOREIGN KEY (`id_log_tipo_postagem`) REFERENCES `log_postagem` (`id_log_postagem`);

--
-- Limitadores para a tabela `log_vende_produto`
--
ALTER TABLE `log_vende_produto`
  ADD CONSTRAINT `log_vende_produto_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `log_vende_produto` (`id_log_venda_produto`),
  ADD CONSTRAINT `log_vende_produto_ibfk_2` FOREIGN KEY (`id_venda`) REFERENCES `log_vende_produto` (`id_log_venda_produto`),
  ADD CONSTRAINT `log_vende_produto_ibfk_3` FOREIGN KEY (`id_frete`) REFERENCES `log_vende_produto` (`id_log_venda_produto`);
...
ALTER TABLE `mensagem`
  ...
  ADD CONSTRAINT `mensagem_ibfk_1` FOREIGN KEY (`id_destinatario`) REFERENCES `mensagem` (`id_mensagem`);

--
-- Limitadores para a tabela `postagem`
--
ALTER TABLE `postagem`
  ADD CONSTRAINT `postagem_ibfk_1` FOREIGN KEY (`id_tipo_postagem`) REFERENCES `postagem` (`id_postagem`);
...
--
ALTER TABLE `venda`
  ADD CONSTRAINT `venda_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `venda` (`id_venda`),
  ADD CONSTRAINT `venda_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `venda` (`id_venda`),
  ADD CONSTRAINT `venda_ibfk_3` FOREIGN KEY (`id_frete`) REFERENCES `venda` (`id_venda`);
COMMIT;
